#!/usr/bin/env python
"""Generate results for the signal reconstruction example in Section 6.2 of the
paper. Note that as this likelihood is very computationally expensive, it was
run with MPI and hence random seeding could not be used."""
...
def main():  # pylint: disable=too-many-locals,too-many-branches,too-many-statements
    ...
    * num_repeats is the PolyChord/dyPolyChord num_repeats setting.
    ...
    start_ind = 1
    nrep = 5
    inds = list(range(start_ind, start_ind + nrep))
